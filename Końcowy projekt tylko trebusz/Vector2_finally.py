"""
Vector2_finally.py -- WARSTWA 1: algebra wektorowa.

Nie zależy od niczego (nawet od math poza importem) i nic nie wie o fizyce.
Można ją testować osobno.

KONWENCJA:
    metody MUTUJĄCE zwracają self  -> można je łączyć w łańcuch
    rotate(a)  zmienia wektor
    rotated(a) zwraca nowy, oryginał bez zmian
Zero alokacji ma znaczenie: solver robi setki tysięcy operacji na sekundę.
"""
...
def normalizeAngle(a: float) -> float:
    ...
    rot = 62.8). Bez tego różnica kątów wyszłaby 6.2 zamiast -0.08 i spaw
    szarpnąłby ciałem o pełny obrót."""
